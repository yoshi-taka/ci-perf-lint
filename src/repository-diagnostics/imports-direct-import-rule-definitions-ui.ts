...
export function createUiImportRuleDefinitions(
  ...
  return [
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, [
        "@material-ui/core",
        "@material-ui/icons",
      ]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["mui-core"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["antd"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["@visx/visx"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["@tremor/react"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["react-bootstrap"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["@headlessui/react"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["@headlessui-float/react"]),
    ...
    {
      enabled: dependencyIndexHasAnyDependency(dependencyIndex, ["@angular/material"]),
