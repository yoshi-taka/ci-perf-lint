...
interface IconEntryData extends MakeContentOptions {
  depNames: readonly string[];
  meta:
    | typeof antDesignIconsDirectImportMeta
    | typeof fontAwesomeDirectImportMeta
    | typeof heroiconsDirectImportMeta
    | typeof lucideAngularIconsMeta
    | typeof lucideDynamicIconMeta
    | typeof tablerIconsDirectImportMeta;
  exactSources: readonly string[];
}

const standardIconDefs: IconEntryData[] = [
  {
    depNames: ["lucide-react"],
...
export function createIconAndAssetImportRuleDefinitions(
  ...
  return [
    ...standardIconDefs.map((d) => toIconDef(dependencyIndex, d)),
    {
